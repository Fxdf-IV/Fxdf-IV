...
<div align="left"> 
  <ul style="font-family:'Special Elite'; text-align: left; display: flex; flex-direction: column; gap: 8px;">
    ...
    <li>⏳ <strong style="color:#8B6F47;">Focus Pomodoro</strong> - A app for focus and break cycles featuring optional website and app blocking. (<a href="https://github.com/Fxdf-IV/Pomodore-App">repo</a>)</li>
